"""
Процессор для обработки аудио электрогитары с помощью улучшенной U-Net модели.
...
from app.models.eg.config import MODEL_PATH, SAMPLE_RATE, MODEL_CONFIG, DEVICE, CHUNK_SIZE, OVERLAP_RATIO
...
def load_model():
    ...
    print(f"[EG Model] Загружена модель из {MODEL_PATH}")
